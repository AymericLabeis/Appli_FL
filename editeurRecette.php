...
if (!empty($_POST)) {
  ...
  if (strlen($nom) >= 5) {
    // Le titre a au moins 5 caractères
    ...
    if ($duree > 0) {
      ...
      if (isset($_FILES['img']) && $_FILES['img']['error'] === UPLOAD_ERR_OK) {
        ...
        if (move_uploaded_file($_FILES['img']['tmp_name'], "ressources/img_recette/$filename")) {
          ...
          $req_recettes = $pdo->prepare('INSERT INTO recettes (nom, ingredients, duree, etapes, id_categories, id_users, img) VALUES (:nom, :ingredients, :duree, :etapes, 1, 1, :img)');
    ...
    $error_nom = 'Le titre de la recette doit comporter au moins 5 caractères.';
  }
}
?>
...
<head>
  ...
  <div class="logo_title">
      <a  href="Recettes.php"><img class= "logo" src="ressources/logo2.png" alt="Image du logo"></a>
      <h1 class="titre">Mes fruits et légumes de saison</h1> 
    </div>
  </header> 
  <div class="titreRecette">
    <h1>Creer votre recette</h1>
  </div>
